...
gluegen.lib
	The location of the Jogamp GlueGen binaries (for build classpath).
	Default: "${dev.base}/lib/gluegen-rt.jar"
joal.lib
	The location of the Jogamp JOAL binaries (for build classpath).
	Default: "${dev.base}/lib/joal.jar"
